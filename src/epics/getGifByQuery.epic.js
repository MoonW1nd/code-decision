...
export function getGifByQueryEpic(action$: Action, state: EpicStateType): Observable {
...
export function initialGetGifByQueryEpic(action$: Action, state: EpicStateType): Observable {
